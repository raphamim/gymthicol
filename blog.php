<?php 
    $title = "Les actualités, témoignages, et réactions sur notre blog";
    ...
    $path = "https://www.gymthicol.eu/blog.php";
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <article class="wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms">
                                <div class="blog-post-image">
                                    <img class="img-responsive" src="images/blog/gymthicol.jpg" alt="Vous avez un coup de mou" />
                                </div>
                                <div class="blog-content">
                                    <h2 class="blogpost-title">
                                    ...
                                    <span> Tags: <b>conseils</b>, <b>mode de vie</b>, <b>gymthicol</b></span>
                                    </div>
                                    <p> 
                                    Lisez ça ! Le service communication de la société Gymthicol vous a préparé une liste des boissons énergisantes naturelles avec des saveurs que vous retrouverez dans notre gamme de produit!
                                    Voici les 4 boissons énergisantes naturelles sélectionnées par la société Gymthicol...
                                    </p>
                                    <a href="boissons-naturelles.php" class="btn btn-dafault btn-details">Continuer à lire</a>
                                </div>
                            </article>
                        </div>
                    </div>
